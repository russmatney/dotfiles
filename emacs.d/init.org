...
| u | Urbint           | entry | (file+headline ~/Dropbox/todo/todo.org Urbint)      | ** URBINT %?\n  %i\n  %a     |
| g | Triage           | entry | (file+headline ~/Dropbox/todo/todo.org Triage)      | ** TRIAGE %?\n  %i\n  %a     |
| b | Blog             | entry | (file+headline ~/Dropbox/todo/todo.org Blog)        | ** BLOG %?\n  %i\n  %a       |
