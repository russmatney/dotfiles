...
(map!
 ...
 "M-2"    (λ! (+workspace/switch-to 2))
 "M-3"    (λ! (+workspace/switch-to 3))
 "M-4"    (λ! (+workspace/switch-to 4))
 "M-5"    (λ! (+workspace/switch-to 5))
 "M-6"    (λ! (+workspace/switch-to 6))
 "M-7"    (λ! (+workspace/switch-to 7))
 "M-8"    (λ! (+workspace/switch-to 8))
 "M-9"    (λ! (+workspace/switch-to 9))
 "M-0"    (λ! (+workspace/switch-to 0))
 "M-l"    #'+workspace/switch-to-last
 ...
 (:leader
   ...
   (:desc "workspace" :prefix "TAB"
     ...
     :desc "Switch to 1st workspace"  :n "1"   (λ! (+workspace/switch-to 1))
     :desc "Switch to 2nd workspace"  :n "2"   (λ! (+workspace/switch-to 2))
     :desc "Switch to 3rd workspace"  :n "3"   (λ! (+workspace/switch-to 3))
     :desc "Switch to 4th workspace"  :n "4"   (λ! (+workspace/switch-to 4))
     :desc "Switch to 5th workspace"  :n "5"   (λ! (+workspace/switch-to 5))
     :desc "Switch to 6th workspace"  :n "6"   (λ! (+workspace/switch-to 6))
     :desc "Switch to 7th workspace"  :n "7"   (λ! (+workspace/switch-to 7))
     :desc "Switch to 8th workspace"  :n "8"   (λ! (+workspace/switch-to 8))
     :desc "Switch to 9th workspace"  :n "9"   (λ! (+workspace/switch-to 9))
     :desc "Switch to 9th workspace"  :n "0"   (λ! (+workspace/switch-to 0))
